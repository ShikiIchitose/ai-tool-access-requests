...
DEBUG = env_bool("DJANGO_DEBUG", default=not RENDER)
...
extra_csrf_trusted_origins = os.environ.get("DJANGO_CSRF_TRUSTED_ORIGINS", "").strip()
...
SECURE_SSL_REDIRECT = env_bool("DJANGO_SECURE_SSL_REDIRECT", default=RENDER)
